...
class TodayForecasts extends React.Component {
    ...
    render() {
        return (
            <div className="Cards">
                <h3 className="Result-title">Current weather based on your location / search :</h3>
                <div className="Card-today">
                    <div className="Weather-details">
                        <p className="Date-time">16:45, 23 September 2019</p>
                        <table>
                            <tr>
                                <td>humidity</td>
                                <td>52%</td>
                    ...
                    <div className="Weather-cond">
                        <p className="Cond-desc">Few clouds</p>
